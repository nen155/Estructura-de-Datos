#ifndef __VECTORDISPERSO_H_MAP
#define __VECTORDISPERSO_H_MAP
...
class const_stored_iterator{
  public:
    ...
    const_stored_iterator(const const_stored_iterator & d) : ite(d.ite) {}
     const_stored_iterator(const stored_iterator & d) : ite(d.ite) {} // Conversion de iterator a const_iterator
    const pair<int, T > & operator *(  ) {return (*ite);}
    const_stored_iterator & operator++( ) {++it; return *this;}
    ...
    bool operator != (const const_stored_iterator & d) {return ite != d.ite; }
    const_stored_iterator & operator= (const const_stored_iterator & d) {d.ite = this.ite}
